...
public:
    ...
    void effect(Inkscape::Extension::Effect *module, ExecutionEnv *, SPDesktop *desktop, Inkscape::Extension::Implementation::ImplementationDocumentCache * docCache) override;
